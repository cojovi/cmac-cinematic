...
export const resourceConfigs: Record<ResourceName, ResourceConfig> = {
  ...
  contracts: { table: 'contracts', title: 'Contract tracking', eyebrow: 'DOCUSIGN / ENVELOPES', copy: 'Monitor signature state, provider errors, and completed private documents.', emptyTitle: 'No contracts yet', emptyCopy: 'Prepared DocuSign envelopes will appear after integration is configured.', Icon: FileSignature, select: '*,contacts(display_name)', orderBy: 'updated_at' },
}
